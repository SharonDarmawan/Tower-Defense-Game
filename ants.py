...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while temp_place is not beehive:
            if self.min_range <= index <= self.max_range and temp_place.bees:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for b in place_bees:
            ...
            if self.armor <= 0 and b.place is not None:
    ...
    def action(self, gamestate):
        ...
        if not self.is_queen:
            ...
            while temp_place.exit:
                if temp_place.exit.ant and not temp_place.exit.ant.is_doubled:
                    temp_place.exit.ant.damage *= 2
                    temp_place.exit.ant.is_doubled = True
